...
var Jd_Hbrain = /** @class */ (function (_super) {
    ...
    Jd_Hbrain.prototype.main = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var data, res, shareCode, _a, _b, t, e_1_1, _c, _d, t, e_2_1, e_3;
            var e_1, _e, e_2, _f;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        _g.trys.push([0, 26, , 28]);
                        this.user = user;
                    ...
                    case 4:
                        ...
                        _a = __values(res.data.signInfo.signTaskList), _b = _a.next();
                        _g.label = 5;
                    case 5:
                        if (!!_b.done) return [3 /*break*/, 11];
                        t = _b.value;
                        if (!(t.currentDay && t.signStatus === 0)) return [3 /*break*/, 10];
                        if (!(this.user.index === 0)) return [3 /*break*/, 7];
                        return [4 /*yield*/, this.api('miniTask_assistCheck', { "itemId": shareCode[0] })];
                    case 6:
                        data = _g.sent();
                        return [3 /*break*/, 9];
                    case 7: return [4 /*yield*/, this.api('miniTask_doSign', { "itemId": "1" })];
                    case 8:
                        data = _g.sent();
                        _g.label = 9;
                    case 9:
                    ...
                    case 13:
                        ...
                        return [7 /*endfinally*/];
                    case 14:
                        _g.trys.push([14, 23, 24, 25]);
                        _c = __values(res.data.scanTaskList), _d = _c.next();
                        _g.label = 15;
                    case 15:
                        if (!!_d.done) return [3 /*break*/, 22];
                        t = _d.value;
                        if (!(t.status === 0)) return [3 /*break*/, 21];
                        console.log(t.title);
                        return [4 /*yield*/, this.api('MiniTask_ScanTask', { "actionType": 1, "scanAssignmentId": t.scanAssignmentId, "itemId": t.itemId })];
                    case 16:
                        data = _g.sent();
                        if (!(data.subCode === 0)) return [3 /*break*/, 21];
                        console.log('开始任务');
