...
!(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_4) {
        switch (_4.label) {
            ...
            case 80:
                _4.sent();
                if (!(res.data.iscandraw === 1)) return [3 /*break*/, 82];
            ...
            case 112:
                e_7 = _4.sent();
                console.log('除草 Error:', e_7.response);
                return [3 /*break*/, 114];
            case 113:
                j++;
                return [3 /*break*/, 105];
            ...
            case 120:
                e_8 = _4.sent();
                console.log('挑逗 Error:', e_8.response);
                return [3 /*break*/, 122];
            case 121:
                j++;
                return [3 /*break*/, 116];
            ...
            case 129:
                ...
                if (!(shareCodesHbHw.length === 0)) return [3 /*break*/, 131];
                return [4 /*yield*/, (0, TS_USER_AGENTS_1.getshareCodeHW)('jxmchb')];
            case 130:
                shareCodesHbHw = _4.sent();
                _4.label = 131;
            case 131:
            ...
            case 149:
                ...
                if (!(shareCodesHW.length === 0)) return [3 /*break*/, 151];
