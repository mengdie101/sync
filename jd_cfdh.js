...
!(function () { return __awaiter(void 0, void 0, void 0, function () {
    var cookiesArr, i, e_1, todayMoney, flag, dwPageIndex, _a, _b, t, _c, _d, xb, e_2_1, tasks, _e, _f, t, prizeInfo, CardList, cards, CardList_1, CardList_1_1, card, e_3_1, richcard, coincard, coincard_1, coincard_1_1, card, e_4_1, richcard_1, richcard_1_1, card, e_5_1, j, j, wallet, build, minLV, _g, _h, b, e_6_1, employee, employee_1, employee_1_1, emp, empRes, e_7_1, _j, _k, sign, e_8_1, MermaidRes, shipRes, bags_1, _l, _m, s, strTypeCnt_1, n, bags, _o, _p, s, strTypeCnt, n, j, _q, _r, t, e_9_1, _s, _t, t, e_10_1, _u, _v, e, employ, e_11_1, _w, _x, b, e_12_1, _y, _z, _0, value, index_1, pool, shareCode_1, shareCode_1_1, code, e_13_1, e_14_1;
    var e_15, _1, e_2, _2, e_3, _3, e_16, _4, e_4, _5, e_5, _6, e_6, _7, e_7, _8, e_8, _9, e_17, _10, e_18, _11, e_9, _12, e_10, _13, e_11, _14, e_12, _15, e_14, _16, e_13, _17;
    var _18;
    return __generator(this, function (_19) {
        switch (_19.label) {
            ...
            case 2:
                ...
                _19.label = 3;
            case 3:
                if (!(i < cookiesArr.length)) return [3 /*break*/, 186];
                cookie = cookiesArr[i];
            ...
            case 10:
                _19.sent();
                try {
                    for (_a = (e_15 = void 0, __values(res === null || res === void 0 ? void 0 : res.Detail)), _b = _a.next(); !_b.done; _b = _a.next()) {
                        t = _b.value;
                    ...
                    try {
                        if (_b && !_b.done && (_1 = _a["return"])) _1.call(_a);
                    }
            ...
            case 24:
                try {
                    if (_d && !_d.done && (_2 = _c["return"])) _2.call(_c);
                }
            ...
            case 30:
                ...
                if (res.ret === 0) {
                    ...
                    cards = '';
                    try {
                        for (CardList_1 = (e_16 = void 0, __values(CardList)), CardList_1_1 = CardList_1.next(); !CardList_1_1.done; CardList_1_1 = CardList_1.next()) {
                        ...
                        try {
                            if (CardList_1_1 && !CardList_1_1.done && (_4 = CardList_1["return"])) _4.call(CardList_1);
                        }
            ...
            case 32:
                res = _19.sent();
                return [4 /*yield*/, (0, TS_USER_AGENTS_1.wait)((_18 = t.dwLookTime * 1000) !== null && _18 !== void 0 ? _18 : 2000)];
            case 33:
                _19.sent();
                if (res.ret === 0) {
                    console.log('加速卡任务完成');
            ...
            case 37:
                try {
                    if (_f && !_f.done && (_3 = _e["return"])) _3.call(_e);
                }
            ...
            case 46:
                try {
                    if (coincard_1_1 && !coincard_1_1.done && (_5 = coincard_1["return"])) _5.call(coincard_1);
                }
                finally { if (e_4) throw e_4.error; }
                return [7 /*endfinally*/];
            case 47:
                _19.trys.push([47, 52, 53, 54]);
            ...
            case 53:
                try {
                    if (richcard_1_1 && !richcard_1_1.done && (_6 = richcard_1["return"])) _6.call(richcard_1);
                }
            ...
            case 69:
                try {
                    if (_h && !_h.done && (_7 = _g["return"])) _7.call(_g);
                }
            ...
            case 91:
                try {
                    if (employee_1_1 && !employee_1_1.done && (_8 = employee_1["return"])) _8.call(employee_1);
                }
            ...
            case 99:
                try {
                    if (_k && !_k.done && (_9 = _j["return"])) _9.call(_j);
                }
            ...
            case 105:
                _19.sent();
                if (!res.StoryInfo.StoryList) return [3 /*break*/, 125];
                if (!res.StoryInfo.StoryList[0].Mermaid) return [3 /*break*/, 112];
                console.log("\u53D1\u73B0\u7F8E\u4EBA\u9C7C\uD83E\uDDDC\u200D\u2640\uFE0F");
            ...
            case 107:
                _19.sent();
                if (!(MermaidRes.iRet === 0)) return [3 /*break*/, 109];
            ...
            case 108:
                ...
                _19.label = 109;
            case 109: return [4 /*yield*/, (0, TS_USER_AGENTS_1.wait)(1000)];
            case 110:
                _19.sent();
                return [4 /*yield*/, api('story/MermaidOper', '_cfd_t,bizCode,ddwTriggerDay,dwEnv,dwType,ptag,source,strStoryId,strZone', {
                        strStoryId: res.StoryInfo.StoryList[0].strStoryId,
            ...
            case 111:
                ...
                _19.label = 112;
            case 112: return [4 /*yield*/, (0, TS_USER_AGENTS_1.wait)(2000)];
            case 113:
                _19.sent();
                if (!res.StoryInfo.StoryList[0].Special) return [3 /*break*/, 117];
            ...
            case 117:
                isCollector = false;
                if (!res.StoryInfo.StoryList[0].Collector) return [3 /*break*/, 123];
                console.log('收藏家出现');
            ...
            case 120:
                ...
                bags_1 = [];
                try {
                    for (_l = (e_17 = void 0, __values(res.Data.Office)), _m = _l.next(); !_m.done; _m = _l.next()) {
                        s = _m.value;
                    ...
                    try {
                        if (_m && !_m.done && (_10 = _l["return"])) _10.call(_l);
                    }
            ...
            case 121:
                ...
                if (!(bags_1.length !== 0)) return [3 /*break*/, 123];
            ...
            case 124:
                _19.sent();
                _19.label = 125;
            case 125: return [4 /*yield*/, api('story/querystorageroom', '_cfd_t,bizCode,dwEnv,ptag,source,strZone')];
            case 126:
                // 清空背包
                res = _19.sent();
                bags = [];
                try {
                    for (_o = (e_18 = void 0, __values(res.Data.Office)), _p = _o.next(); !_p.done; _p = _o.next()) {
                        s = _p.value;
                        bags.push(s.dwType);
                        bags.push(s.dwCount);
                    }
                    ...
                    try {
                        if (_p && !_p.done && (_11 = _o["return"])) _11.call(_o);
                    }
            ...
            case 127:
                ...
                if (!(bags.length !== 0)) return [3 /*break*/, 129];
            ...
            case 128:
                ...
                console.log('卖贝壳收入:', res.Data.ddwCoin, res.Data.ddwMoney);
                _19.label = 129;
            case 129: return [4 /*yield*/, api('story/QueryRubbishInfo', '_cfd_t,bizCode,dwEnv,ptag,source,strZone')];
            case 130:
                // 垃圾🚮
                res = _19.sent();
                if (!(res.Data.StoryInfo.StoryList.length !== 0)) return [3 /*break*/, 137];
                console.log('有垃圾');
            ...
            case 140:
                ...
                _19.label = 141;
            case 141:
                _19.trys.push([141, 147, 148, 149]);
                _q = (e_9 = void 0, __values(tasks.Data.TaskList)), _r = _q.next();
                _19.label = 142;
            case 142:
                if (!!_r.done) return [3 /*break*/, 146];
                t = _r.value;
                if (!([1, 2].indexOf(t.dwOrderId) > -1 && t.dwCompleteNum < t.dwTargetNum && t.strTaskName !== '升级1个建筑')) return [3 /*break*/, 145];
            ...
            case 148:
                try {
                    if (_r && !_r.done && (_12 = _q["return"])) _12.call(_q);
                }
                finally { if (e_9) throw e_9.error; }
                return [7 /*endfinally*/];
            case 149: return [4 /*yield*/, api('story/GetActTask', '_cfd_t,bizCode,dwEnv,ptag,source,strZone')];
            case 150:
                tasks = _19.sent();
                return [4 /*yield*/, (0, TS_USER_AGENTS_1.wait)(2000)];
            case 151:
                ...
                _19.label = 152;
            case 152:
                _19.trys.push([152, 158, 159, 160]);
                _s = (e_10 = void 0, __values(tasks.Data.TaskList)), _t = _s.next();
                _19.label = 153;
            case 153:
                if (!!_t.done) return [3 /*break*/, 157];
                t = _t.value;
                if (!(t.dwCompleteNum === t.dwTargetNum && t.dwAwardStatus === 2)) return [3 /*break*/, 156];
            ...
            case 159:
                try {
                    if (_t && !_t.done && (_13 = _s["return"])) _13.call(_s);
                }
                finally { if (e_10) throw e_10.error; }
                return [7 /*endfinally*/];
            case 160: return [4 /*yield*/, api('story/GetActTask', '_cfd_t,bizCode,dwEnv,ptag,source,strZone')];
            case 161:
                tasks = _19.sent();
                return [4 /*yield*/, (0, TS_USER_AGENTS_1.wait)(2000)];
            case 162:
                _19.sent();
                if (!(tasks.Data.dwStatus === 3)) return [3 /*break*/, 164];
            ...
            case 163:
                ...
                _19.label = 164;
            case 164: return [4 /*yield*/, (0, TS_USER_AGENTS_1.wait)(2000)
                // 导游
            ];
            case 165:
                _19.sent();
            ...
            case 166:
                // 导游
                res = _19.sent();
                if (!!res.TourGuideList) return [3 /*break*/, 167];
                console.log('手动雇佣4个试用导游');
                return [3 /*break*/, 175];
            case 167:
                _19.trys.push([167, 173, 174, 175]);
                _u = (e_11 = void 0, __values(res.TourGuideList)), _v = _u.next();
                _19.label = 168;
            case 168:
                if (!!_v.done) return [3 /*break*/, 172];
                e = _v.value;
                if (!(e.strBuildIndex !== 'food' && e.ddwRemainTm === 0)) return [3 /*break*/, 171];
            ...
            case 174:
                try {
                    if (_v && !_v.done && (_14 = _u["return"])) _14.call(_u);
                }
                finally { if (e_11) throw e_11.error; }
                return [7 /*endfinally*/];
            case 175: return [4 /*yield*/, (0, TS_USER_AGENTS_1.wait)(2000)];
            case 176:
                _19.sent();
                _19.label = 177;
            case 177:
                _19.trys.push([177, 183, 184, 185]);
                _w = (e_12 = void 0, __values(['fun', 'shop', 'sea', 'food'])), _x = _w.next();
                _19.label = 178;
            case 178:
                if (!!_x.done) return [3 /*break*/, 182];
                b = _x.value;
            ...
            case 184:
                try {
                    if (_x && !_x.done && (_15 = _w["return"])) _15.call(_w);
                }
            ...
            case 185:
                ...
                return [3 /*break*/, 3];
            case 186:
                _19.trys.push([186, 201, 202, 203]);
                _y = __values(cookiesArr.entries()), _z = _y.next();
                _19.label = 187;
            case 187:
                if (!!_z.done) return [3 /*break*/, 200];
                _0 = __read(_z.value, 2), value = _0[0], index_1 = _0[1];
                if (!(shareCodeHW.length === 0)) return [3 /*break*/, 189];
                return [4 /*yield*/, (0, TS_USER_AGENTS_1.getshareCodeHW)('jxcfd')];
            case 188:
                shareCodeHW = _19.sent();
                _19.label = 189;
            case 189: return [4 /*yield*/, (0, TS_USER_AGENTS_1.getShareCodePool)('jxcfd', 30)];
            case 190:
                pool = _19.sent();
            ...
            case 198:
                try {
                    if (shareCode_1_1 && !shareCode_1_1.done && (_17 = shareCode_1["return"])) _17.call(shareCode_1);
                }
            ...
            case 202:
                try {
                    if (_z && !_z.done && (_16 = _y["return"])) _16.call(_y);
                }
