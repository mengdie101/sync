...
var Jd_plantBean__help = /** @class */ (function (_super) {
    ...
    Jd_plantBean__help.prototype.help = function (users) {
        return __awaiter(this, void 0, void 0, function () {
            var res, full, users_1, users_1_1, user, shareCodePool, shareCode, my, shareCode_1, shareCode_1_1, code, e_4_1, e_5, e_6_1;
            var e_6, _a, e_4, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                    ...
                    case 5:
                        ...
                        shareCode = Array.from(new Set(__spreadArray([], __read(shareCodePool), false)));
                        return [4 /*yield*/, this.api('plantBeanIndex', { "monitor_source": "plant_m_plant_index", "monitor_refer": "", "version": "9.2.4.2" })];
                    case 6:
                        res = _c.sent();
