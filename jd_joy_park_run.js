...
var Joy_Park_Run = /** @class */ (function (_super) {
    ...
    Joy_Park_Run.prototype.main = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var assets, rewardAmount, res, apTaskList, _a, _b, t, e_1_1, _c, _d, t, apTaskDetail, taskItemList, i, e_2_1, sum, success, _e, _f, t, _g, _h, member, energy, i, e_3;
            var e_1, _j, e_2, _k, e_4, _l, e_5, _m;
            var _o;
            return __generator(this, function (_p) {
                switch (_p.label) {
                    ...
                    case 4:
                        ...
                        _a = __values(apTaskList.data), _b = _a.next();
                        _p.label = 5;
                    case 5:
                    ...
                    case 15:
                        ...
                        _c = __values(apTaskList.data), _d = _c.next();
                        _p.label = 16;
                    case 16:
                    ...
                    case 35:
                        try {
                            for (_e = __values(((_o = res === null || res === void 0 ? void 0 : res.data) === null || _o === void 0 ? void 0 : _o.detailVos) || []), _f = _e.next(); !_f.done; _f = _e.next()) {
                                t = _f.value;
                    ...
                    case 38:
                        ...
                        if (res.code === 0) {
                            console.log('组队成功');
                            try {
                                for (_g = __values(res.data.members), _h = _g.next(); !_h.done; _h = _g.next()) {
                                    member = _h.value;
                                    if (member.captain) {
