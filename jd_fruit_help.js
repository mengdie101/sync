    ...
    return __generator(this, function (_j) {
        switch (_j.label) {
            ...
            case 30:
                ...
                _j.label = 31;
            case 31:
                _j.trys.push([31, 38, 39, 40]);
                _d = (e_4 = void 0, __values(res.assistStageList)), _e = _d.next();
                _j.label = 32;
            case 32:
                if (!!_e.done) return [3 /*break*/, 37];
                t = _e.value;
                if (!(t.percentage === '100%' && t.stageStaus === 2)) return [3 /*break*/, 35];
